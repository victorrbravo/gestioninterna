...
SERVER_URL        =  u"http://localhost:8080/"
LOGIN_URL         =  u"http://localhost:8080/login"
TEMPLATES_PATH    =  u"/var/www/media/templates"
TEMPLATES_URL     =  u"http://localhost:8080/media/templates/"
#HOMESAFET_PATH    =  u"/home/usuario/safet/gestioninterna"
HOMESAFET_PATH    =  u"/home/usuario"
MEDIA_PATH        =  u"/static/media"
ALL_TMP_PATH      =  u"/home/usuario/safet/gestioninterna/static/tmp"
TMP_PATH    	  =  u"/static/tmp"
MEDIA_URL         =  u"http://localhost:8080/static/media"
...
<script type="text/javascript" src="http://localhost:8080/media/jquery-latest.js"></script> 
<!-- <script type="text/javascript" language="javascript" src="http://localhost:8080/media/js/DataTables/media/js/jquery.js"></script> -->
<script type="text/javascript" language="javascript" src="http://localhost:8080/media/js/DataTables/media/js/jquery.dataTables.js"></script>
<script type="text/javascript" src="http://localhost:8080/media/jquery.svg.js"></script>
<script type="text/javascript" src="http://localhost:8080/media/jquery.debug.js"></script>
<script type="text/javascript" src="http://localhost:8080/media/jquery.svggraph.js"></script>
<script type="text/javascript" src="http://localhost:8080/media/jquery.svgplot.js"></script>
<script type="text/javascript" src="http://localhost:8080/media/jquery.svganim.js"></script>
<script type="text/javascript" src="http://localhost:8080/media/jquery.svgdom.js"></script>
<script type="text/javascript" src="http://localhost:8080/media/jquery.svgfilter.js"></script>
<link type="text/css" href="http://localhost:8080/media/jquery.svg.css" rel="Stylesheet" />
<!--		<style type="text/css" title="currentStyle">
			@import "http://localhost:8080/media/js/DataTables/media/css/demo_page.css";
			@import "http://localhost:8080/media/js/DataTables/media/css/demo_table.css";
		</style> -->
...
$.post('http://localhost:8080/intranet/viewtable' ,{},
function(data) {
//alert(data);
var myjson = null;
...
SAFETLOGIN = u"""
<form action="http://localhost:8080/intranet/gologin" class="signin" method="post" enctype="multipart/form-data">
...
<td><input id="password" name="password" type="password" value="" /> <small><a href="http://localhost:8080/intranet/goresendpassword">¿Lo has olvidado?</a></small></td>
</tr>
<tr>
...
<form action="http://192.168.12.76:8888/goregister" class="signin" method="get" enctype="multipart/form-data">
<fieldset class="common-form standard-form">
<table cellspacing="0">
<tr>
...
#<form action="http://localhost:8080/intranet/register" role="form"  method="post" enctype="multipart/form-data">
SAFETREGISTER = u"""
<form action="http://localhost:8080/register" role="form"  method="post" enctype="multipart/form-data">
   ...
   <div class="form-group">
    <label for="rif">Registro Información Fiscal (RIF)</label>
...
<form action="http://localhost:8080/intranet/changepassword" class="signin" method="post" enctype="multipart/form-data">
<fieldset class="common-form standard-form">
<table cellspacing="0">
<tr>
...
<form action="http://localhost:8080/intranet/resendpassword" class="signin" method="post" enctype="multipart/form-data">
<fieldset class="common-form standard-form">
<table cellspacing="0">
<tr>
...
SAFETGOLOGIN = u"""
     ...
     <a href="http://localhost:8080/intranet/login">
...
<html>
<head>
  <script src="http://localhost:8080/media/jquery-latest.js"></script>
  <link rel="stylesheet" href="http://localhost:8080/media/main.css" type="text/css" />
  <link rel="stylesheet" href="http://localhost:8080/media/jquery.autocomplete.css" type="text/css" />
  <link rel="stylesheet" href="http://localhost:8080/media/main.css" type="text/css" />
  <link rel="stylesheet" href="http://localhost:8080/media/css/ui-lightness/jquery-ui-1.8.8.custom.css" type="text/css" />

  <script type="text/javascript" src="http://localhost:8080/media/jquery.bgiframe.min.js"></script>
  <script type="text/javascript" src="http://localhost:8080/media/jquery.autocomplete.js"></script>
  <script>
  ...
  $("#inputform").autocomplete('http://localhost:8080/intranet/formcomplete', {
                width: 400,
                multiple: true,
                multipleSeparator: " ",
...
<div >Formulario </div>
<br/>
<form action="http://localhost:8080/intranet/1"
...
<script>
  $(document).ready(function(){
    ...
    var data = "Core Selectors Attributes Traversing Manipulation CSS Events Effects Ajax Utilities".split(" ");
  $("#inputform").autocomplete('http://localhost:8080/intranet/conscomplete', {
                width: 400,
                multiple: true,
                multipleSeparator: " ",
                formatItem: formatItem,
...
<form action="http://localhost:8080/intranet/2"
class="signin" method="post"  enctype="multipart/form-data">
<fieldset class="common-form standard-form">
<table cellspacing="0">
<tr>
